...
-   Standard deviation of the distribution of a given estimate is called standard error = $\frac{\sigma}{\sqrt n}$. Confidence intervals are extension of standard errors, see picture below (beta-hat is the estimate of the regression coefficient beta from the data).
