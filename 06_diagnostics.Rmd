...
A more detailed explanation, including the formula for computing leverage, can be found in @casella1983.
...
The value of residuals and leverage can also be summarized using Cook's distance [@cook1977].
Cook's distance of a single observation is a scaled difference between the predicted values of the model including all observations and the predicted values of the model with the specific observation removed.
Therefore, observations with high Cook's distance are those, which has either very high leverage, a very high residual or some combination of both.
